...
def heat_metrics( mins:int, limit, func=sq, burn:bool=True, x:int=cpu_count(), units='C', device='nct6796', ): # -> dict
...
if __name__ == '__main__':
    ...
    try:
        p = Pool(processes=4)
        p.map(heat_metrics( mins = 1, burn=True, x=4, units='C'), range(4))
    except TypeError:
        pass
    #print()
